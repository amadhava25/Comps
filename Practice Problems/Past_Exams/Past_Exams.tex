...
\end{prb}
\begin{solutions}
	Let $p(x)= x^{5} + 1$. By plugging in all of the elements in $\mathbb{F}_{19}$, we find that $18$ is a root of $p(x)$. Hence, using polynomial long division in $\mathbb{F}_{19}$, 
		\begin{equation}
			p(x) = (x + 18)(x^{4} + 18x^{3} + x^{2} + 18x + 1). 
		\end{equation}
	\textcolor{red}{[!! Complete Later !!]}
\end{solutions}
