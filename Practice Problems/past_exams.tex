...
\begin{document}
	...
	\end{prb}
		...
		Suppose $E, F$ are two measurable subsets of the real numbers that both have positive measure. We will complete this problem using two different techniques. In the first technique, we will use convolutions; in the second, we will use the Lebesgue density theorem. 
