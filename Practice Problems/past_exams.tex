...
\begin{document}
	...
	\end{equation*}
	$X$ is defined by $\omega = 0$ so that $x^{2}+ x^{4} - x^{1}x^{3} = C$, where $C$ is some constant. Since $X$ passes through the origin, one has $C = 0$. Therefore, $X$ is given in coordinates by $x^{2} + x^{4} - x^{1}x^{3}= 0$. 
	\newpage 
