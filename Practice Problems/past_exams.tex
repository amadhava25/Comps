...
\begin{document}
	...
	\begin{itemize}
		...
		\item The universal covering space of $T^{2}$ is $\mathbb{R}^2$; of $S^1$ is $\mathbb{R}$, of $S^{n}$ is itself for $n \geq 2$. For all $n\geq 1$, the universal cover of $\mathbb{RP}^n$ is $S^1$. 
