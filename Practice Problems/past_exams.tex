...
f2		\begin{equation*}
	...
	\begin{enumerate}[itemsep =-2pt,label = (\alph{*})]
		...
		\end{equation*}
		Thus since we have shown that every subsequence of $\{\norm{f_{n} - f}_{L^{1}}\}$ has a convergent subsequence that converges to $0$, we conclude that $f_{n} \to f$ in $L^{1}$. 
	\end{enumerate}
