...
f2		\begin{equation*}
	...
	\end{equation*}
	Thus taking the limit $r = (1 - |z|)/2$ on the right side yields, 
	\begin{equation*}
	...
	\end{prb}
	Let $\Delta$ denote the open unit disk, and let $\Gamma = \{f: \Delta \to \mathbb{C} \mid f \text{ holomorphic}, \operatorname{Im}{f(0)} = 0, \operatorname{Re}{f(z)} < 1\}$. 
