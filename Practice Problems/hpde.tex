...
\begin{document}
	...
	\begin{proof}
		...
		\end{equation*}
		Using Plancherel's theorem, we conclude that \todo{What is the significance of this conservation law? Should connect back to energy, but how?}
		\begin{equation*}
			\norm{\phi_{t}}_{H^{s- 1}} + \norm{\nabla \phi}_{H^{s - 1}} = \norm{g}_{H^{s - 1}} + \norm{\nabla f}_{H^{s - 1}}. 
		\end{equation*}
	\end{proof}
	...
	\end{equation}
	Moreover, we present \textbf{Gronwall's lemma}. 
